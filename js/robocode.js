    ...
    _update: function () {
      ...
      for (var r in battle_manager._robots) {
        ...
        if (robot["bullet"]) {
          ...
          var wall_collide = !Utils.is_point_in_square(robot["bullet"]["x"], robot["bullet"]["y"], 2, 2, ARENA_WIDTH-2, ARENA_HEIGHT-2);
          ...
          if (wall_collide) {
            ...
            for (var r2 in battle_manager._robots) {
              ...
              var robot_hit = Utils.distance(robot["bullet"]["x"], robot["bullet"]["y"], enemy_robot["x"], enemy_robot["y"]) < 20;
          ...
          switch (event["signal"]) {
            ...
            case "MOVE":
              ...
              for (var r2 in battle_manager._robots) {
                ...
                var robot_hit = Utils.distance(new_x, new_y, enemy_robot["x"], enemy_robot["y"]) < 25;
                if (robot_hit) {
                  enemy_robot["health"]--;
                  robot["health"]--;
                  this._send(r, {
